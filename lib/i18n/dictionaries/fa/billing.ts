const billing = {
  ...
  completeSubscribeTo: "اشتراک خود در طرح {plan} را کامل کنید",
  confirmSubscribeTitle: "تأیید اشتراک",
  confirmSubscribeText: "اشتراک {plan} با {price} در ماه؟ مبلغ از کارت {brand} با پایان {last4} برداشت می‌شود.",
