const settings = {
  ...
  deleteAccountConfirm: "Аккаунт будет удалён НАВСЕГДА: номер будет освобождён, история звонков и данные оплаты стёрты. Это нельзя отменить. Всё равно удалить?",
