const billing = {
  ...
  pay: "支払う",
  completeUpgradeTo: "{plan}プランへのアップグレードを完了",
  completeSubscribeTo: "{plan}プランの登録を完了",
  confirmSubscribeTitle: "登録の確認",
  confirmSubscribeText: "{plan}（月額{price}）に登録しますか？末尾{last4}の{brand}カードに請求されます。",
