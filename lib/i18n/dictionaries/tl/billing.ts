const billing = {
  ...
  completeSubscribeTo: "Kumpletuhin ang iyong subscription sa {plan}",
  confirmSubscribeTitle: "Kumpirmahin ang subscription",
  confirmSubscribeText: "Mag-subscribe sa {plan} sa {price}/buwan? Sisingilin ang iyong {brand} card na nagtatapos sa {last4}.",
