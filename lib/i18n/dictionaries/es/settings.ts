const settings = {
  ...
  deleteAccountConfirm: "Esto eliminará PERMANENTEMENTE tu cuenta, liberará tu número y borrará todo el historial de llamadas y facturación. Introduce el código que te acabamos de enviar para confirmar.",
  deleteVerifyTitle: "Confirmar eliminación de la cuenta",
