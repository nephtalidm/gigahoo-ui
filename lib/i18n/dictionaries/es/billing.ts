const billing = {
  ...
  downgradeScheduledTitle: "Cambio a plan inferior programado",
  ...
  pay: "Pagar",
  completeUpgradeTo: "Completa tu mejora al plan {plan}",
  completeSubscribeTo: "Completa tu suscripción al plan {plan}",
  confirmSubscribeTitle: "Confirmar suscripción",
  confirmSubscribeText: "¿Suscribirte a {plan} por {price}/mes? Se cobrará a tu tarjeta {brand} terminada en {last4}.",
