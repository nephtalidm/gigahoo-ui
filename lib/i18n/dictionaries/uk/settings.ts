const settings = {
  ...
  deleteAccountConfirm: "Акаунт буде видалено НАЗАВЖДИ: номер буде звільнено, історію дзвінків і платіжні дані стерто. Це неможливо скасувати. Все одно видалити?",
