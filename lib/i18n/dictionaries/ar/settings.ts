const settings = {
  ...
  deleteAccountConfirm: "سيؤدي هذا إلى حذف حسابك نهائيًا وتحرير رقمك ومحو كل سجل المكالمات وبيانات الفوترة. أدخل الرمز الذي أرسلناه لك للتأكيد.",
  deleteVerifyTitle: "تأكيد حذف الحساب",
