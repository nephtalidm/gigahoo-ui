const billing = {
  ...
  completeSubscribeTo: "أكمل اشتراكك في خطة {plan}",
  confirmSubscribeTitle: "تأكيد الاشتراك",
  confirmSubscribeText: "الاشتراك في {plan} مقابل {price}/شهريًا؟ سيتم الخصم من بطاقة {brand} المنتهية بـ {last4}.",
