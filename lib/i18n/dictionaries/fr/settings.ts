const settings = {
  ...
  websiteLanguage: "Langue du compte",
  websiteLanguageHint: "La langue utilisée dans tout le tableau de bord de votre compte.",
  ...
  deleteAccountConfirm: "Cela supprimera DÉFINITIVEMENT votre compte, libérera votre numéro et effacera tout l'historique des appels et de facturation. Saisissez le code que nous venons de vous envoyer pour confirmer.",
  deleteVerifyTitle: "Confirmer la suppression du compte",
