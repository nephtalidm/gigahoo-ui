const billing = {
  ...
  completeSubscribeTo: "Finalisez votre abonnement au forfait {plan}",
  confirmSubscribeTitle: "Confirmer l'abonnement",
  confirmSubscribeText: "S'abonner à {plan} pour {price}/mois ? Votre carte {brand} se terminant par {last4} sera débitée.",
