const settings = {
  ...
  websiteLanguage: "Account Language",
  websiteLanguageHint: "The language used across your account dashboard.",
  ...
  deleteAccountConfirm: "This will PERMANENTLY delete your account, release your phone number, and erase all call history and billing data. Enter the code we just sent you to confirm.",
  deleteVerifyTitle: "Confirm account deletion",
