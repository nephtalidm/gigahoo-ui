      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 pt-5 pb-6 sm:px-6 sm:pt-7 lg:pt-4 lg:pb-4">
        ...
        <div className="grid grid-cols-1 items-stretch gap-[4.5rem] lg:grid-cols-2 lg:gap-16">
          <div className="relative isolate flex flex-col items-start">
            ...
            <div className="pointer-events-none absolute -inset-x-4 -top-5 -bottom-12 -z-10 overflow-hidden sm:-inset-x-6 sm:-top-7 lg:hidden">
              <video
          ...
          <div className="relative">
            ...
            <div className="flex flex-col rounded-2xl border border-border bg-card p-6 shadow-sm lg:absolute lg:inset-0 lg:top-[3.25rem] lg:min-h-0">
              ...
              {/* Demo-call entry point — opens the centered "Talk to Gigahoo" popup. */}
              <div className="mt-4 border-b border-border pb-4">
                <Button
                  className="h-auto min-h-9 w-full whitespace-normal bg-black py-2 text-center text-sm leading-tight text-white hover:bg-black/90"
